# Yak Koet Ko Poet Ma — Exam Quiz System — Full-Stack

ระบบสร้างแบบทดสอบก่อนสอบจากไฟล์เรียน PDFs/PPTXs Full-Stack Web Application ตั้งแต่ต้น
...
3. ตั้งชื่อ เช่น `yak-koet-ko-poet-ma-deploy`
...
```bash
npx wrangler d1 create Yak_Koet_Ko_Poet_Ma-db
```
...
2. ดู log ของ workflow จะเห็น:
   ```
   ✅ Backend deployed to https://yak-koet-ko-poet-ma-backend.yourname.workers.dev
   ```

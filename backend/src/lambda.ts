...
import { MemoryQuizAttemptRepository } from './infrastructure/memory/memory-quiz-attempt-repository'
import { MemoryQuizRepository } from './infrastructure/memory/memory-quiz-repository'
...
const container = createContainer({
  ...
  quizRepository: new MemoryQuizRepository(),
  quizAttemptRepository: new MemoryQuizAttemptRepository(),
})
